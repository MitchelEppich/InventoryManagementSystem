    ...
    <div className="inventoryFilters unselectable">
        <ul className="flex flex-wrap p-0 leading-loose text-crimson">
            <li className="w-48 my-2 mx-auto">
                <p>Company:</p>
                <input className="w-1/4 text-crimson" type="checkbox" value="CKS" /><span className="w-1/4">CKS</span>
                <input className="w-1/4 text-crimson" type="checkbox" value="SON" /><span className="w-1/4">SON</span>
                <input className="w-1/4 text-crimson" type="checkbox" value="SWG" /><span className="w-1/4">SWG</span>
                <input className="w-1/4 text-crimson" type="checkbox" value="BVR" /><span className="w-1/4">BVR</span>
